    ...
    return (
        <div className="container_contactUs" style={{backgroundColor: theme.backgroundColor_contact_us}} >
            ...
            <form className="form_contactUs">
                <GrAccessibility size={25} className="mdName_contact_us" style={{color: theme.color_icon_contact_us}} color='#05386b' />
                ...
                <MdEmail size={25} className='mdEmail_contact_us' style={{color: theme.color_icon_contact_us}} color='#05386b' />
                ...
                <button className="button_contactUs" style={{backgroundColor: theme.backgroundColor_button_contact_us, color: theme.color_contact_us}} > Submit </button>
