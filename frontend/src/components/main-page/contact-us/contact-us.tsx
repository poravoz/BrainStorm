    ...
    return (
        <div className="container_contactUs" style={{backgroundColor: theme.backgroundColor_contact_us}} >
            ...
            <form className="form_contactUs">
                ...
                <input required placeholder={t("contact-us.placeholder_name")} className="input_contactUs" style={{backgroundColor: theme.backgroundColor_input_contact_us}} type="text" /> <br />
                ...
                <input required placeholder={t("contact-us.placeholder_email")}  className="input_contactUs" style={{backgroundColor: theme.backgroundColor_input_contact_us}} type="email"/> <br />
                <p className="message_contactUs" style={{color: theme.color_contact_us}}> {t("contact-us.text_up_placeholder_message")}</p>
                <textarea required placeholder={t("contact-us.placeholder_message")} className="textarea_contact_us" style={{backgroundColor: theme.backgroundColor_input_contact_us}}></textarea> <br />
