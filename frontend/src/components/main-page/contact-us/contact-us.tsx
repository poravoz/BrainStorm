    ...
    return (
        <div className="container_contactUs" style={{backgroundColor: theme.backgroundColor_contact_us}} >
            ...
            <form className="form_contactUs">
                ...
                <input required placeholder="Your name" className="input_contactUs" style={{backgroundColor: theme.backgroundColor_input_contact_us}} type="text" /> <br />
                ...
                <input required placeholder="Your email" className="input_contactUs" style={{backgroundColor: theme.backgroundColor_input_contact_us}} type="email"/> <br />
                <p className="message_contactUs" style={{color: theme.color_contact_us}}> Your message: </p>
                <textarea required className="textarea_contact_us" style={{backgroundColor: theme.backgroundColor_input_contact_us}} placeholder="Enter Something"></textarea> <br />
